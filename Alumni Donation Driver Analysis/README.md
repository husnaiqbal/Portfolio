...
**Alumni Donation Drivers**

This project explores what drives alumni to donate and the amount they contribute. I worked with two datasets. This being the following:
...
- Predict the likelihood of donation and the amount donated
