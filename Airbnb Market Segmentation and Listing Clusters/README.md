...
**Airbnb Market Segementation and Listing Clusters**

This project explores how clustering Airbnb listings can reveal meaningful customer groups using unsupervised learning and boosted tree regression. Listings were grouped into clusters based on features like host behavior, property size, and engagement levels.


**Key Highlights:**

- Listings were seperated into groups: 
...
- Features Driving Price inlcuded the following: 
