...
- **Sample Data Population:** Realistic data was inserted into the database to simulate real-world healthcare operations.

- **Advanced SQL Queries & Views developed to support the following:**
    ...
    - License renewal alerts for providers
    
    - Patient appointment histories and summaries


Please download the document to learn more about this project!
